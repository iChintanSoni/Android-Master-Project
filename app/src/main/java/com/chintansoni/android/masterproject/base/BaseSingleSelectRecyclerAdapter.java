...
public abstract class BaseSingleSelectRecyclerAdapter<T, VH extends BaseViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public BaseSingleSelectRecyclerAdapter(Class<VH> viewHolderClass, int modelLayout) {
